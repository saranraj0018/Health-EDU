            ...
            <tbody className="text-black font-manrope font-semibold text-sm">
              {[
                ...
                <tr key={index} className="even:bg-gray-100">
                  <td className="px-6 py-3 whitespace-nowrap">{row.department}</td>
                  <td className="px-6 py-3 whitespace-nowrap">{row.highest}</td>
                  <td className="px-6 py-3 whitespace-nowrap">{row.average}</td>
                  <td className="px-6 py-3 whitespace-nowrap">{row.students}</td>
                </tr>
              ))}
            </tbody>
          </table>
