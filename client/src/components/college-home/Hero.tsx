  ...
  return (
    <>
      <section className="px-[1em] lg:px-[8em] xl:px-[8em] 2xl:px-[10em]">
        <div className="college-banner h-50 md:h-80 lg:h-100 rounded-3xl p-4 flex flex-col justify-between">
            ...
            <div className="text-xl md:text-3xl lg:text-4xl text-gray-200 font-medium font-manrope">
                {CollegeName}
            </div>
        </div>
      </section>
